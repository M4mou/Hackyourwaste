...
class HomeScreenState extends State<HomeScreen> {
  ...
  double iconsize = 20;
  List<Widget> widgets = [HomeSubscreen(),Text('Shop'),Text('Scan'),Text('Notification'),Text('Profile'),];
  ...
  Widget build(BuildContext context) {
    ...
    onTap: () {},
    child: SizedBox(width: 56, height: 56, child: Icon(Icons.qr_code_scanner,color: Colors.white, size: iconsize)),
    ),
    ),
    ),
              label: "Scan"
