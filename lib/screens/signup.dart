    ...
    return Center(child: SizedBox(width: w * 0.872, child: ListView(
        ...
        children:[
          ...
          Row(
            ...
            TextButton(
              ...
              child:Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: household?Colors.white:Color(0xffc3c3c3),
                    fontSize: 15,
                    fontFamily: "Inter",
            ...
            ), TextButton(style: ButtonStyle(overlayColor:MaterialStateProperty.all<Color>( Colors.transparent)),
              onPressed: () {
                setState(() {
                  household = false ;
                });
              ...
              child:Container(
                ...
                child: Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: household?Color(0xffc3c3c3):Colors.white,
                    fontSize: 15,
                    fontFamily: "Inter",
                    fontWeight: FontWeight.w700,
                    letterSpacing: 0.10,
